...
#define FRAME_COUNT_ALL		std::numeric_limits<long>::max()
...
public:
    ...
    */
    void setFrameIndex( long nFrameIndex, long nNumOfFrames = 1 );
    ...
    */
    void setTimestamp(long long time, long duration = UNDEFINED_DURATION);
...
protected:
    ...
    bool shiftFrameIndex( long nTarFrameIndex, long nSrcFrameIndex, long nNumOfFrames = FRAME_COUNT_ALL );
