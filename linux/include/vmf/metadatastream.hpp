...
public:
    ...
    */
    ...
    public:
        ...
        VideoSegment( const std::string& title, double fps, long long timeStart,
                      long duration = 0, long width = 0, long height = 0 );
    ...
    */
    bool import( MetadataStream& srcStream, MetadataSet& srcSet, long nTarFrameIndex, long nSrcFrameIndex, long nNumOfFrames = FRAME_COUNT_ALL, MetadataSet* pSetFailure = NULL );
    ...
    */
    void convertTimestampToFrameIndex(
        long long timestamp, long duration,
...
protected:
    ...
    std::shared_ptr<Metadata> import( MetadataStream& srcStream, std::shared_ptr< Metadata >& spMetadata, std::map< IdType, IdType >& mapIds, 
        long nTarFrameIndex, long nSrcFrameIndex, long nNumOfFrames = FRAME_COUNT_ALL );
